		...
		<div class="card">
			...
			<div class="card-body">
				<a href="excel"> <img src="../resources/images/BulkExcel.png"
					width="100" height="40" />
				</a> <a href="pdf"> <img src="../resources/images/BulkPdf.png"
					width="100" height="40" />
				</a>
				<c:choose>
						...
						<table class="table table-hover">
							...
							<c:forEach items="${list}" var="ob">
								<tr>
									...
									<td><a href="view?sid=${ob.shipId}" class="btn btn-warning"> <!-- <img src="../resources/images/view.png" width="20" height="20" /> -->
											VIEW
